    ...
    try:
        ...
        if _macro_scores is not None:
            ...
            module_sources["technical"] = _build_module_source(
                ...
                data_status=_status_from_timestamp(technical_timestamp, False, timeframe=timeframe) if has_touche_payload else "FALLBACK",
            ...
            module_sources["fundamental"] = _build_module_source(
                ...
                data_status=_status_from_timestamp(fundamental_timestamp, False, timeframe=timeframe) if has_fundamental_payload else "FALLBACK",
        ...
        module_sources["sentinel"] = _build_module_source(
            ...
            data_status="FALLBACK" if sentinel_fallback_used else _status_from_timestamp(sentinel_timestamp, False, timeframe=timeframe),
        ...
        module_sources["news"] = _build_module_source(
            ...
            data_status="FALLBACK" if news_fallback_used else _status_from_timestamp(news_timestamp, False, timeframe=timeframe),
        ...
        module_sources["quantum"] = _build_module_source(
            ...
            data_status="FALLBACK" if quantum_fallback_used else _status_from_timestamp(quantum_timestamp, False, timeframe=timeframe),
